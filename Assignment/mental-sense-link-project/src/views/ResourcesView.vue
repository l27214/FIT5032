  ...
  <div class="container pt-3">
    <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
      <div class="col-lg-6 px-0">
        ...
        <p class="lead my-3">
          Access a curated selection of psychological resources designed to help you manage stress,
          overcome cyberbullying, and deal with depression.
        </p>
        <p class="lead mb-0">
    ...
    <div class="row mb-2">
      ...
      <div class="col-md-6">
        ...
        >
          <div class="col p-4 d-flex flex-column position-static">
            <strong class="d-inline-block mb-2 text-success-emphasis">Mindfulness Practices</strong>
